...
sources:
  - title: "Fix Your Hot Tub with This Complete Troubleshooting Guide"
    ...
    accessed: "2026-07-30"
    note: "Consumer troubleshooting chart. Undated, general Hot Spring guidance. Cited for the 'jet operation is weak or surging' entry and its listed causes."
  - title: "Hot Tub Pump Not Working? Troubleshooting & Repair Guide"
    url: "https://www.jacuzzi.com/en-us/Hot-Tub-Pump-Not-Working.html"
    publisher: "Jacuzzi"
    accessed: "2026-07-30"
    note: "General, undated consumer guide. Cited for identifying dirty filters and low water level as the most common causes of weak jet flow."
faq: []
---
...
Follow your manual for filter and valve access. Do not open the equipment compartment or work on the pump directly. The checks below are limited to water level, filters, and externally accessible valves.

## The usual suspects, in order

### Water level too low

Jacuzzi recommends verifying the waterline sits at least one to two inches above the highest jet, typically around mid-skimmer level. Low water allows air into the suction lines, which can starve the pump and trigger a protective shutdown (Jacuzzi). Hot Spring's troubleshooting chart lists the same fix for weak or surging jets: add water to the spa (Hot Spring). This is worth checking first since it takes no tools beyond a garden hose.
...
1. **Check the water level against your manual's fill line**, adding water through the filter compartment if it's low.
2. **Inspect the filter for visible dirt, clogging, or damage** and clean it following your manual's method.
3. **Check any jet or diverter valves you can access from outside the spa** to confirm they're open for the jets you're testing.
4. **Note whether the issue affects all jets or only some.** A single weak jet can point to that jet or its valve; several or all jets weak together tends to point more toward water level, the filter, or trapped air.
5. **Test both low and high speed if your pump has them**, and watch for surging rather than steady flow.
6. **Recheck after each change** rather than adjusting several things at once, so you know what actually fixed it.
